function [psth,binT] = get_basic_psth(spikeTS,eventTS,minT,maxT,binWidth)
% GET_BASIC_PSTH   A simple PSTH function without any loops
% Usage:
...
%
%
% https://github.com/biogeo/electrophysiology/blob/master/looplessPSTH.m
%
